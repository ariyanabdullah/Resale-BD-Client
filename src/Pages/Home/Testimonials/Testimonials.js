...
const Testimonials = () => {
  return (
    <div>
      <section className="mt-8 bg-neutral">
        <div className="container mx-auto flex flex-col items-center pb-6 mb-4 md:p-10 md:px-12">
          <h1 className="text-2xl font-bold my-2  text-center">Testimonials</h1>
        ...
        <div className="container mx-auto grid grid-cols-1 gap-8 lg:gap-20 md:px-10 md:pb-10 lg:grid-cols-2">
          <div className="flex flex-col items-center mx-12 lg:mx-0">
            <div className="relative text-center">
              ...
              <p className="px-6 py-1 text-lg italic">
                Very good product with awosome quality. 100% acurate and
                premimum. I am so happy.Super Fast Delivery.
              </p>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 512 512"
          ...
          <div className="flex flex-col items-center max-w-lg mx-12 lg:mx-0">
            <div className="relative text-center">
              ...
              <p className="px-6 py-1 text-lg italic">
                Amazing product ! I am So much happy to recive my Product. You
                guys are amazing. Their Delivery was so fast. I recommended this
                Shop .
              </p>
              <svg
                xmlns="http://www.w3.org/2000/svg"
